...
export const genres = ["Action", "Sci-Fi", "Adventure", "Drama", "Fantasy", "Family"]
// Собрать в массив все жанры фильмов (без повторения)

export const arrayOfGenres = (films) => {
...
// export const arrayOfActors = (array) => {
//     const actors = array.reduce((result, { actors }) => {
...
// console.log(arrayOfActors(films))


// // Сортировать фильмы по рейтингу по убыванию

// export const decreasingSort = (array) => {
//     return array.sort((a, b) => b.imdbRating - a.imdbRating)
// }

// console.log(decreasingSort(films))


// // Создать новый массив, где объекты фильмов будут состоять из следующих полей: id, title, released, plot

// export const shortArray = (array) => {
//     return array.map(({ id, title, released, plot, ...rest }) => ({ id, title, released, plot }))
// }

// console.log(shortArray(films))
...
// export const whichFilmsInThisYear = (array, year) => {
//     return array.filter((film) => film.year === year)
// }

// console.log(whichFilmsInThisYear(films, 2021))
...
// export const stringSearchTitle = (array, string) => {
//     return array.filter((film) => film.title.includes(string))
// }

// console.log(stringSearchTitle(films, 'Harry'))
...
// export const stringSearchTitleAndPlot = (array, string) => {
//     return array.filter((film) => film.title.includes(string) || film.plot.includes(string))
// }

// console.log(stringSearchTitleAndPlot(films, 'Voldemort'))


// // Task 8

// export const dependentSearch = (array, field, definition) => {
//     return array.filter((film) => film[field] === definition)
// }

// console.log(dependentSearch(films, 'year', 2021))